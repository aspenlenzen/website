 ...
 *   logo     — image path (e.g. "assets/logos/cantos-dark.png"); omit to show the name as text
...
export const caseStudies = [
  {
    ...
    "problem": "Crush Studio grew over 100x in the span of a year, but their internal operations hadn't kept pace. The team managed complex projects, timelines, budgets, and personnel across multiple workstreams, but the systems supporting those operations were fragmented.",
    "tags": {
      "company": [
        "Woman Owned",
        "Creative Services"
    ...
    "sections": [
      {
        ...
        "title": "The Challenge",
        "paragraphs": [
          "Crush Studio grew over 100x in the span of a year, but their internal operations hadn't kept pace. The team managed complex projects, timelines, budgets, and personnel across multiple workstreams, but the systems supporting those operations were fragmented."
        ],
        "beforeAfter": {
          "before": [
  ...
  },
  {
    ...
    "problem": "As Eve Atlas scaled, their investment data scattered across multiple locations made it impossible to track LP exposure across entities and deals, leaving critical questions about complex relationships unanswered.",
    "tags": {
      "company": [
        "Venture Capital"
      ],
  ...
  },
  {
    ...
    "problem": "Cantos was ready to bring its community together for the first time and wanted to host its first Annual General Meeting, a milestone gathering that would bring limited partners, startup founders, and portfolio companies into one room. As its first event of this scale, there was no existing blueprint to follow, making thoughtful event planning essential to create a seamless experience that felt established and intentional.",
    "tags": {
      "company": [
        "Venture Capital"
      ],
