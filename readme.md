...
- `assets/` — owl_wax_seal.png (logo), site photography, `logos/` client logos
- `index.dc.html`, `Resume.dc.html`, `Consulting.dc.html` — the live site pages
- `case-studies.js` — case-study data for the Consulting page
